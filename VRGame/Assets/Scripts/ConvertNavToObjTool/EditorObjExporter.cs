...
public class EditorObjExporter : ScriptableObject
{
    ...
    [MenuItem("Custom/Convert/Convert NavMesh to Mesh")]
    static void ConvertNav()
    {
        UnityEngine.AI.NavMeshTriangulation triangles = UnityEngine.AI.NavMesh.CalculateTriangulation();
        Mesh mesh = new Mesh();
        mesh.vertices = triangles.vertices;
        mesh.triangles = triangles.indices;
        //string meshParsed = MeshToString(mesh);
        //MeshToFile(mesh, "Mesh0001");
    ...
    public static string MeshToString(Mesh mf)
    {
        Mesh m = mf;
